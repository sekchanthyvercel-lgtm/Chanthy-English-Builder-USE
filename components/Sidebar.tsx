      ...
      <div className={`w-full h-full flex flex-col overflow-hidden ${isOpen ? 'opacity-100' : 'opacity-0'} transition-opacity duration-300`} style={{ width: `${width}px` }}>
        ...
        <div className="flex-1 overflow-y-auto no-scrollbar">
          <div className="p-6 flex flex-col gap-6">
            ...
            <div className="flex bg-slate-100/50 p-1 rounded-xl gap-1 border border-slate-200/50">
              {['GRAMMAR', 'READING', 'VOCABULARY', 'LISTENING'].map(mod => (
                <button
                  key={mod}
                  onClick={() => onModuleChange(mod.charAt(0) + mod.slice(1).toLowerCase())}
                  className={`flex-1 py-1.5 rounded-lg text-[8px] font-bold tracking-tight transition-all ${
            ...
            {activeModule.toUpperCase() === 'READING' && (
              <div className="flex items-center justify-between bg-slate-50 p-3 rounded-xl border border-slate-200/60">
                <span className="text-[8px] font-bold text-slate-600 uppercase tracking-widest">Global Reading Source</span>
                <button 
                  onClick={() => onSingleReadingTextChange(!isSingleReadingText)}
                  className={`w-8 h-4 rounded-full transition-all relative ${isSingleReadingText ? 'bg-orange-600' : 'bg-slate-300'}`}
                >
            ...
            <div className="flex flex-col gap-1.5">
              <button 
                ...
                className="w-full flex items-center justify-between bg-white p-2.5 rounded-xl border border-slate-200 hover:border-orange-200 transition-all group"
              >
                <div className="flex items-center gap-2">
                  <i className="fa-solid fa-palette text-slate-400 group-hover:text-orange-500 text-[10px]"></i>
                  <span className="text-[8px] font-bold text-slate-600 uppercase tracking-widest">Test Design</span>
                </div>
                <i className="fa-solid fa-chevron-right text-slate-300 group-hover:text-orange-400 text-[7px]"></i>
              </button>
              ...
              >
                <div className="flex items-center gap-2">
                  <i className="fa-solid fa-plus-circle text-slate-400 group-hover:text-orange-500 text-[10px]"></i>
                  <span className="text-[8px] font-bold text-slate-600 uppercase tracking-widest">Add Exercise Type</span>
                </div>
                <i className="fa-solid fa-chevron-right text-slate-300 group-hover:text-orange-400 text-[7px]"></i>
              </button>
              ...
              >
                <div className="flex items-center gap-2">
                  <i className="fa-solid fa-book text-slate-400 group-hover:text-orange-500 text-[10px]"></i>
                  <span className="text-[8px] font-bold text-slate-600 uppercase tracking-widest">Subjects</span>
                </div>
                <i className="fa-solid fa-chevron-right text-slate-300 group-hover:text-orange-400 text-[7px]"></i>
              </button>
